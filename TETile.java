...
public class TETile {
    ...
    public static TETile[] stringToTiles(String words) {
        TETile[] returnTiles = new TETile[words.length()];
        for (int count = 0; count < words.length(); count++) {
            returnTiles[count] = new TETile(words.charAt(count), Color.black, Color.white, "idk", 100);
        }
        return returnTiles;
    }
